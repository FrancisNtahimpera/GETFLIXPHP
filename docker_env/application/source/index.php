      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul l class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            ...
            <!-- <?php if ($_session['name' ]) echo'<a class="nav-link" href="profil.php"><img src="https://img.icons8.com/external-wanicon-flat-wanicon/64/000000/external-profile-user-interface-wanicon-flat-wanicon.png" width="35px" /></a><span> bonjour  '.$_session['name' ].' </span> ' ?>
          </li> -->
...
?>
 <!-- --------------------------CAROUSEL--------------------------------------------------------------------------------- -->
  ...
  <div class="carousel-indicators">
    ...
    <?php   for ($i = 3; $i <= 19; $i++) {echo '<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="'.$i.' " aria-label="Slide '.$i.'" ></button>';}?>
